...
class Fixture:
    def __init__(self, root: Path):
        ...
        self.config = Config(
            ...
            cli_release_repository="777genius/plugin-kit-ai", cli_release_tag="agentplugins-v0.1.16",
...
def artifacts(challenge: str = "a" * 64) -> dict[str, Any]:
    ...
    external = {
        ...
        "binding": {
            ...
            "release_repository": "777genius/plugin-kit-ai", "release_tag": "agentplugins-v0.1.16",
