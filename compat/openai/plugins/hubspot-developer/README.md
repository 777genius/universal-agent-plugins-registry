...
- Transport: `stdio`
- Runtime: integrity-locked prerelease `@hubspot/cli@8.14.0-beta.0`; install scripts are disabled, and the platform-optional `fsevents` script is separately lock-accounted
...
- Security review: `npm audit signatures` passes; the locked closure currently reports 0 high, 0 critical, and 5 moderate advisories
