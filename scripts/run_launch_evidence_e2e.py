...
TRUSTED_OBSERVER_SUBJECT = (
    f"repo:{TRUSTED_CATALOG_REPOSITORY_OWNER}@{TRUSTED_CATALOG_REPOSITORY_OWNER_ID}/"
    f"{TRUSTED_CATALOG_REPOSITORY_NAME}@{TRUSTED_CATALOG_REPOSITORY_ID}:"
    f"environment:{TRUSTED_OBSERVER_ENVIRONMENT}"
)
...
def read_production_config() -> dict[str, Any]:
    ...
    if (
        ...
        or value.get("directory_source_digest") != "sha256:4d5838c8ebc7ad79bf1daa410765f18ddb22ce39c0eeacd3507d461aa37ac4d1"
