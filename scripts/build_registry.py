...
LEGACY_CATALOG_DIGESTS = {
    ...
    ROOT / "catalog" / "v2" / "catalog.json": "sha256:8fde037780ea82fa7dc0355489a98821a01aa398be5114d0284583f169a6a02d",
...
CLIENT_IDS = ("codex", "chatgpt", "cursor", "copilot", "vscode", "kiro", "claude", "gemini", "opencode", "cline", "windsurf")
...
LOCKED_NPM_LAUNCHER_DIGESTS = frozenset({
    ...
    # Playwright recovers interrupted installs with one immutable retirement marker.
    "sha256:1da536485aa641e760c9fe86ca5d3850cdfc8b155416335f1eb4a3b67dd8ef4b",
})
