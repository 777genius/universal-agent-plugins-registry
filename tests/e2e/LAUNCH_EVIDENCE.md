...
`777genius/plugin-kit-ai` / `agentplugins-v0.1.15`. This makes the immutable
...
`universal-agent-plugins@0.1.15` npm facade is resolved from the npm registry;
...
external discovery record cannot pass. The fixed 0.1.15 contract must be
