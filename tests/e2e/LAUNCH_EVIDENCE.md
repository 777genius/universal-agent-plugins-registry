...
`777genius/plugin-kit-ai` / `agentplugins-v0.1.13`. This makes the immutable
...
`universal-agent-plugins@0.1.13` npm facade is resolved from the npm registry;
...
external discovery record cannot pass. Release 0.1.13 therefore fails closed
