...
'''
    ...
    def test_catalog_gate_attests_both_canonical_subjects_and_exact_oidc_invocation(self) -> None:
        ...
        self.assertEqual(workflow["env"]["AGENTPLUGINS_VERSION"], "0.1.25")
        self.assertEqual(workflow["env"]["AGENTPLUGINS_COMMIT"], "d168b28bcdeef0c558bee3935adab25abb9f6267")
  ...
  --completed two-lane-readiness/two-lane-readiness.json""")
    ...
    def test_upstream_package_cohort_authenticates_exact_release_assets(self) -> None:
        ...
        self.assertIn('AGENTPLUGINS_VERSION: "0.1.25"', body)
        self.assertIn("AGENTPLUGINS_COMMIT: d168b28bcdeef0c558bee3935adab25abb9f6267", body)
        self.assertIn("83f7785383a47b82523ff610893df51ee979d6f444f7de6723b07fbc80cec2e4", body)
