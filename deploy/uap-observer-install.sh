...
runtime_manifest_digest=c93cd2d8df6723c9e2174dd79147c5d33e73b4da9beb3d6b29c80f824628f5b0
...
if [ -e /opt/uap-observer-current ] || [ -L /opt/uap-observer-current ]; then
  ...
  observer_validate_installed_closure_sources "$installed_closure" "$untrusted_source_root" \
    ...
    480e2c22770e1fa16a22d18d22317fec44ef756c88a4b5af7800e304a0e2b173 \
...
adapter_digest=480e2c22770e1fa16a22d18d22317fec44ef756c88a4b5af7800e304a0e2b173
