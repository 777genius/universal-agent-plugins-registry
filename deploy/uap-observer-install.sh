...
test "$(sha256sum "$install_lib" | cut -d' ' -f1)" = fe50644b7ba653f9be8b4de5eb0263b9186a06df0bb2edd8f1282f4108410457
. "$install_lib"
...
runtime_manifest_digest=01e56f4fb602b1d1071f1e5aed8623e94540d329b133fba5d776113713d6a2e3
