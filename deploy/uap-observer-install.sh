...
test "$(sha256sum "$install_lib" | cut -d' ' -f1)" = e94baddaaad01637970586ed944d28a548e1aea35c977a865c872de3f5142428
. "$install_lib"
...
runtime_manifest_digest=72b1ef43323871687b5f684db4300c686760b37de8de91dec96e2a5cfdb3b32d
