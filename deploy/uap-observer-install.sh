...
runtime_manifest_digest=cb61c77cfacfc5ef0075fda2ba4380deaa1308e65fb9cacfb9febd67042c77bb
...
if [ -e /opt/uap-observer-current ] || [ -L /opt/uap-observer-current ]; then
  ...
  observer_validate_installed_closure_sources "$installed_closure" "$untrusted_source_root" \
    ...
    2d0abc0319fc89f9e05f9e5c2c61d423f2456dc6c1fd1b4a59a648ab04dde64d \
...
adapter_digest=2d0abc0319fc89f9e05f9e5c2c61d423f2456dc6c1fd1b4a59a648ab04dde64d
